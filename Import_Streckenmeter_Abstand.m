...
%
%    /Volumes/Studenten/kalb/Dateneingang/SILAB Kontrolle Moritz/Silabdaten/Vp01.asc
%
% To extend the code to different selected data or a different text file,
% generate a function instead of a script.

% Auto-generated by MATLAB on 2017/02/01 15:36:27

TTC_Data = containers.Map;

for i = [2 4 6 7 12 15 16 17 18 19 23 24 25 27 28 32 34 37 39 40] %% Versuchspersonen auswählen
...
Streckenmeter = cell2mat(raw(:, 1));
LongAbstandStostangenVoraus = cell2mat(raw(:, 2));
...
VP('Streckenmeter') = Streckenmeter;
VP('LongAbstandStostangenVoraus') = LongAbstandStostangenVoraus;

test = 0;

TTC_Data(sprintf('VP_%d',i)) = VP;
